  ...
  return (
    <SprintLayout
      ...
      footerContent={
        <>
          <p>
            In de aankomende sprint gaan we ons prototype afronden tot een definitief ontwerp.
            Hierbij maken we gebruik van het ophalen en verwerken van de laatste feedback en voeren
            we extra testen uit om de gebruikerservaring te optimaliseren. Daarnaast richten we ons
            op het volledig werkend maken van de webapplicatie, zowel front- als backend en het
            technisch uitwerken van de interne werking van de Phubbom.
          </p>
          <p>
            Onze eind expositie is op 4 juni en we streven er naar om ons volledig uitgewerkt en
            werkend eindproduct te kunnen presenteren!
          </p>
        </>
      }
    >
      <div className="sprint4__col">
        ...
        <p>
          ...
          visueel en technisch uitwerken van het prototype. De focus lag op het ontwikkelen van een
          compact en speels object dat eenvoudig meegenomen kon worden naar eventuele third spaces.
        </p>

        <h4>Visueel:</h4>
        <p>
          Voor het ontwerp van de bom zijn verschillende schetsen gemaakt, waarbij rekening werd
        ...
        <p>
          ...
          van de gebruiker gepersonaliseerde vragen worden gegenereerd en deze vervolgens
          uitspreekt. Hiervoor is een webapplicatie ontwikkeld waarbij de gebruiker de mogelijkheid
      ...
      <div className="sprint4__col">
        ...
        <p>
          ...
          en een interactieve demonstratie van de Phubbom. De ontvangen feedback gaf ons nieuwe
          inzichten in de beleving van het spel. Het concept werd positief opgevangen door het
          speelse karakter en de persoonlijke vragen. Tegelijkertijd kregen we waardevolle feedback
      ...
      <div className="sprint4__col">
        ...
        <p>
          ...
          nieuwe aanpassingen van het ontwerp. Hierbij lag de focus op het verbeteren van de
          samenwerking tussen de digitale webapp en de fysieke bom, zodat het spel vrijwel geheel
      ...
      <div className="sprint4__col sprint4__col--image-container">
        ...
        <h4>Testen</h4>
        <p>
          Het prototype is getest bij verschillende groepen om de gebruikswijze en beleving te
          kunnen evalueren. Tijdens de test hebben we de participanten het spel laten ervaren zonder

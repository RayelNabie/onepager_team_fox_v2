  ...
  return (
    ...
    >
      ...
      <div className="sprint2__col">
        ...
        <h4>Test 1</h4>
        <p>
          Terwijl wij als tweetal een gesprek voerden, observeerden we de reactie van de andere
          aanwezigen. Hieruit bleek dat mensen die op hun telefoon zaten vrijwel niets meekregen van
          de interactie naast hen, zij zaten volledig in hun eigen bubbel. Mensen zonder telefoon
          bleken daarentegen veel meer in het moment te zitten en de sociale signalen om hen heen op
          te vangen.
        </p>
        <h4>Test 2</h4>
        <p>
          In dit scenario gingen we zelf op onze telefoon zitten scrollen zodra er anderen de lift
          betraden. De resultaten waren opvallend: bijna alle proefpersonen grepen direct ook naar
          hun eigen smartphone. Dit bevestigde onze aanname dat de telefoon vaak wordt gebruikt als
          reflexmatige sociale buffer om ongemakkelijke stiltes te vermijden.
        </p>
      </div>

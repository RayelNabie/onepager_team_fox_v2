      ...
      <div className="phubbing__content">
        ...
        <div className="phubbing__description">
          <p className="phubbing__text">
            ...
            gezamenlijke momenten. In third places (informele ontmoetingsplekken buiten thuis en werk) gebeurt dit
            constant. Jongvolwassenen zitten fysiek samen maar zijn mentaal afwezig, wat leidt tot oppervlakkigere
            gesprekken en verminderde sociale verbondenheid.
          </p>
        </div>
      </div>
    </section>

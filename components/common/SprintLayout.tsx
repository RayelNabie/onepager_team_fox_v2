    ...
    return (
        <section className={`sprint${sprintNumber} sprint-layout`}>
            <div className={`sprint${sprintNumber}__content sprint-layout__content`}>
                {visual && (
                    <div className={`sprint${sprintNumber}__visual-container sprint-layout__visual-container`}>
                        {visual}
                    </div>
                )}
                <div className={`sprint${sprintNumber}__header sprint-layout__header`}>
                    <h1 className={`sprint${sprintNumber}__title sprint-layout__title`}>Sprint {sprintNumber}</h1>
                    {subtitle && <h4 className={`sprint${sprintNumber}__subtitle sprint-layout__subtitle`}>{subtitle}</h4>}
                </div>
...
export const SprintDivider = ({ direction, sprintNumber }: { direction: 'left' | 'right', sprintNumber: number }) => (
    <div className={`sprint${sprintNumber}__divider sprint${sprintNumber}__divider--${direction} sprint-layout__divider sprint-layout__divider--${direction}`}>
